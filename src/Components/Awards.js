          ...
          <div className="position-relative">
            ...
            <div className="row gx-xxl-5">
              ...
              <div className="col-lg-4">
                ...
                <div className="block-four border-30 ps-lg-4 ps-3 pe-lg-4 pe-3 pt-15 pb-30 mt-45 lg-mt-30 wow fadeInUp">
                  <div className="block-title d-inline-block position-relative mt-20 mb-250 lg-mb-150 sm-mb-100" />
                </div>
              </div>
            </div>
